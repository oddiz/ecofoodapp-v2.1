import PieChartFromFood from "@/components/pages/index/FoodCard/PieChart";
...
export function FoodCard({
  ...
  return (
    <div
      ...
      } flex  cursor-pointer flex-col overflow-hidden rounded-lg border-[1px] p-2 relative h-32 w-44 `}
    >
