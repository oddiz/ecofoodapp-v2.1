...
const PieChartFromFood = ({
  ...
  const CenteredMetric: React.FC<PieCustomLayerProps<PieChartData>> = ({
    centerX,
    centerY,
  }) => {
    return (
  ...
  const ArcLabelsComponent: NonNullable<
    PieSvgProps<PieChartData>["arcLabelsComponent"]
  > = ({ datum, label, style }) => {
  ...
  return (
    <PieChart
      ...
      layers={[
        ...
        "arcLinkLabels",
        "legends",
        CenteredMetric as PieCustomLayer<MayHaveLabel>,
      ]}
      ...
      motionConfig="stiff"
      arcLabelsComponent={
        ArcLabelsComponent as PieSvgProps<MayHaveLabel>["arcLabelsComponent"]
      }
      defs={[
        {
          id: "dots",
